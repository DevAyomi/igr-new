...
function fetchPayeDetails(payeId) {
  ...
  $.ajax({
    type: "GET",
    url: `${HOST}/get-special-users?payer_id=${payeId}`,
    dataType: "json",
    headers: {
          ...
          const row = `
              <tr>
                ...
                <td>
                  ...
                  <a href="edit-staff.html?id=${staff.id}&payerId=${
            staff.payer_id
          }&auserId=${special_user_id}&apayerId=${payeId}" class="btn btn-primary btn-sm">Edit</a>
