...
const adminUser = JSON.parse(localStorage.getItem("taxofficeUser"));
...
const SessionManager = {
  ...
  startSession: function (token) {
    ...
    localStorage.setItem("taxofficeSession", JSON.stringify(sessionData));
  },
  ...
  getSessionData: function () {
    const sessionStr = localStorage.getItem("taxofficeSession");
  ...
  logout: function () {
    // Clear local storage
    localStorage.removeItem("taxofficeSession");
    localStorage.removeItem("taxofficeUser");
