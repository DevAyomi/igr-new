      ...
      $("#taxCertificate").html(`
        ...
        <div class="flex justify-center mt-4">
          <div class="flex items-center">
            ...
            <h1 class="text-xl">Plateau IGR Portal</h1>
          </div>
        </div>
          ...
          <div class="flex justify-between items-center">
            ...
            <table class="table-sm table-borderless">
              <tr>
                ...
                <td>${tax_certificate.surname}, ${tax_certificate.first_name} ${
        tax_certificate.middle_name
      }</td>
              </tr>
              <tr>
                <th>RC No.:</th>
              ...
              <tr>
                ...
                ${tax_certificate.state}, Nigeria, ${
        tax_certificate.local_area
      } L.G.A</td>
              </tr>
              <tr>
