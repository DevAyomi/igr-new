...
async function sendPaymentToDb(reference) {
  ...
  $.ajax({
    ...
    error: function (request, error) {
      console.log(error);
      $("#invoiceCard").html(
        `A system error occured.....please report this issue.`
      );
    },
  });
}
      ...
      $("#receiptCard").html(`
            ...
            <div class="flex  justify-between px-6 mt-4">
              ...
              <div class="w-full md:mr-[-10%]">
                ...
                <p class="fontBold text-left">${invoice_info.surname} ${
        invoice_info.first_name
      }</p>
                <p class="text-[#222234] text-sm md:w-[60%]">${
