...
async function openInvoice(invoicenum, price) {
  ...
  if (userInvoices.status === 1) {
    ...
    TotalInvoice += `
        ...
        <div class="mt-2 px-4 ">
        <img src="./assets/img/logo.png" alt="" class="w-[80px] h-[70px]">
        </div>
  `;
    ...
    if (userInvoices.message.length > 1) {
      ...
      TotalInvoice += `
                <tr class="border-t border-[#6F6F84]">
                  ...
                  <td></td>
                  <td></td>
                  <td class="text-[#000] text-sm">${sumArray(
                    formatMoney(parseInt(theTotal))
                  )}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="text-[#000] text-xl fontBold">${sumArray(
                    formatMoney(parseInt(theTotal))
                  )}</td>
                  <span class="d-none" id="theBal" data-money="${parseInt(
                    theTotal
                  )}">${formatMoney(parseInt(theTotal))}</span>
                </tr>
          ...
          <div class="px-6">
            <table class="table table-borderless">
              ...
              <tr class="border-b border-b border-[#6F6F84]">
                <td class="text-sm">PAYE</td>
                <td class="text-sm">01</td>
                <td class="text-sm"></td>
                <td class="text-sm">${formatMoney(
                  parseInt(invoice_info.amount_paid)
                )}</td>
              </tr>
              <tr>
                <td class="text-[#555555] text-sm">Sub Total</td>
              ...
              <tr>
                ...
                )}">${formatMoney(parseInt(invoice_info.amount_paid))}</span>
              </tr>
