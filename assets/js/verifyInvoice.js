...
$("#verifyInvoice").on("click", () => {
  ...
  if (invoiceNumber === "") {
    $(".verifiyer").html(
      "<p class='text-[#ff0000] text-sm'>Please insert your Invoice Number</p>"
    );
      ...
      .then((data) => {
        ...
        if (data.status === 1) {
          ...
          if (specificDate < currentDate) {
            $("#verifyInvoice").removeClass("hidden");
            $("#verInvv").html(`
              <h1 class="fontBold text-2xl text-center text-dark">Verify Invoice</h1>

              <div class="flex justify-center mt-5">
                <img src="./assets/img/notPaid.png" alt="">
              </div>

              <p class="text-center text-dark mt-2 text-xl">This invoice has Expired!!</p>
              ...
              <div class="flex justify-center">
                <div class="flex justify-between mt-4 gap-3">
                  ...
                  <a type="button"  href="../invoiceGeneration/create.html" class="button flex gap-3 items-center px-10">
            ...
            if (data.message.payment_status == "unpaid") {
              ...
              <p class="text-center text-dark mt-2 text-xl">This invoice has not been paid!!</p>

              <p class="text-center text-dark mt-3 text-sm text-lg">Please pay before the due date</p>
            ...
            `);
              ...
              <p class="text-center text-dark mt-2 text-xl">This invoice has been paid</p>
          ...
          $(".verifiyer").html(
            `<p class='text-[#ff0000] text-sm'>invoice number "<span class="fontBold textPrimary">${invoiceNumber}"</span> was not found</p>`
          );
          $("#verifyInvoice").removeClass("hidden");
        }
      });
