  ...
  try {
    ...
    if (userinvoice.data.length > 0) {
      ...
      invoiceContainer += `
        ...
        <!-- Billing Information -->
        <div
          class="grid grid-cols-3 gap-6 mb-8 bg-white p-3 shadow-sm rounded-2xl"
        >
          <!-- Bill From -->
          <div class="flex flex-col">
            ...
            <div
              class="h-full text-break text-gray-600 bg-gray-50 p-3 rounded-lg space-y-2 border border-gray-100"
            >
      ...
      invoiceContainer += ` 
        ...
        <!-- Signature -->
        <div class="text-right mt-8 flex flex-col items-center justify-end">
